...
import com.easybeach.catalog.service.CategoriaMenuService;
...
public class AdminCategoriaMenuController {

    private final CategoriaMenuService service;

    public AdminCategoriaMenuController(CategoriaMenuService service) {
    ...
    @GetMapping
    public List<CategoriaMenuResponse> listar(@AuthenticationPrincipal EasyBeachUserPrincipal principal) {
